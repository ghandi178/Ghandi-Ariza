...
image = cv.imread('dataset/Pepaya/003.jpg')
cv.imshow('Pepaya', rescale(cv.imread('dataset/Pepaya/003.jpg')))
cv.waitKey(0)
########################################################## open image berupa array
print(cv.imread('dataset/Pepaya/003.jpg'))
...
for img in images :
    ...
    im_name = "dataset/pepaya_kontras/" + str(i) + ".png"
...
for img in images :
    ...
    im_name1 = "dataset/pepaya_grey/" + str(i) + ".png"
...
for img in images :
    ...
    im_name2 = "dataset/pepaya_edge/" + str(i) + ".png"
