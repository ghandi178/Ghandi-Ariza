...
# image = cv.imread('dataset/Kemangi/003.jpg')
# cv.imshow('Pepaya', rescale(cv.imread('dataset/Kemangi/003.jpg')))
# cv.waitKey(0)
# ########################################################## open image berupa array
# print(cv.imread('dataset/Kemangi/003.jpg'))
...
for img in images :
    ...
    im_name = "dataset/kemangi_kontras/" + str(i) + ".png"
...
for img in images :
    ...
    im_name1 = "dataset/kemangi_grey/" + str(i) + ".png"
...
for img in images :
    ...
    im_name2 = "dataset/kemangi_edge/" + str(i) + ".png"
